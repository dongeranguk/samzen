...
<center><b>글쓰기</b>
<br>
<form method="post" name="writeform" action="/Web/MVC/writePro.do" onsubmit="return writeSave()">
...
<tr>
	...
	<input type="button" value="목록 보기" OnClick="window.location=/Web/MVC/list.do">
	</td>
</tr>
</table>
</form>
