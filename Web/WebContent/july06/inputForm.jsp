...
<div id = "wrap">
	<form action="inputPro.jsp" name="userinput" onsubmit="return checkIt()" method="post">
		...
		<div id="body">
			<table width="500px">
				...
				<tr>
					<th>Blog</th>
					<td><input type="text" name="blog" clss="w300" maxlength="50" /></td>
				</tr>
				<tr>
					<th>우편번호</th>
					<td>
						<input type="text" name="zipcode" /> <input type="button" values="우편번호 검색" class="inputBtn" onclick="javascript:zipCheck();" />
	...
	<div id="footer">
		...
		<input type="reset" name="reset" class="inputBtn" value="다시 입력" />
